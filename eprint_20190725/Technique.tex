...
%We conclude the proof of \cref{bound:KKL} by proving \cref{eq:nei3}. We prove \cref{eq:nei3} using the following corollary of the seminal KKL theorem \cite{KKL88} from \citet{BKK14}.
...
\end{align}
\noindent
%\Inote{too technical? \rnote{yes!\nnote{made some adjustments below}}}
...
%We conclude by proving \cref{eq:proj}. We first observe 
